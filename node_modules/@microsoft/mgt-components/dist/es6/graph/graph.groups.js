...
const groupTypeValues = ['any', 'unified', 'security', 'mailenabledsecurity', 'distribution'];
export const isGroupType = (value) => typeof value === 'string' && groupTypeValues.includes(value);
export const groupTypeConverter = (value, defaultValue = 'any') => isGroupType(value) ? value : defaultValue;
/**
 ...
 */
export const findGroups = (graph, query, top = 10, groupTypes = ['any'], groupFilters = '') => __awaiter(void 0, void 0, void 0, function* () {
    let cache;
 ...
 * @returns {Promise<Group[]>} An array of Groups
 */
export const findGroupsFromGroup = (graph, query, groupId, top = 10, transitive = false, groupTypes = ['any']) => __awaiter(void 0, void 0, void 0, function* () {
    let cache;
...
export const getGroup = (graph, id, requestedProps) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = (yield graph.api(apiString).middlewareOptions(prepScopes(validGroupQueryScopes)).get());
    if (getIsGroupsCacheEnabled()) {
 ...
 * @returns
 */
export const findGroupsFromGroupIds = (graph, query, groupIds, top = 10, groupTypes = ['any'], filters = '') => __awaiter(void 0, void 0, void 0, function* () {
    const foundGroups = [];
