...
import { CacheService, equals, MgtTemplatedTaskComponent, prepScopes, Providers, ProviderState } from '@microsoft/mgt-element';
 ...
 */
export const isCollectionResponse = (value) => Array.isArray(value === null || value === void 0 ? void 0 : value.value);
const responseTypes = ['json', 'image'];
const isResponseType = (value) => typeof value === 'string' && responseTypes.includes(value);
const responseTypeConverter = (value, defaultValue = 'json') => isResponseType(value) ? value : defaultValue;
/**
...
export class MgtGet extends MgtTemplatedTaskComponent {
    constructor() {
        ...
        this.renderLoading = () => {
            ...
            return isCollectionResponse(this.response)
                ? this.renderValueContentWithDefaultTemplate(html `${this.response.value.map(v => this.renderTemplate('value', v, v.id))} ${loading} `)
                : loading;
        };
        /**
        ...
        this.renderContent = () => {
            if (this.hasTemplate('value') && isCollectionResponse(this.response)) {
                const valueContent = isCollectionResponse(this.response)
                    ? html `
    ...
    renderValueContentWithDefaultTemplate(valueContent) {
        var _a, _b;
        if (this.hasTemplate('default')) {
            ...
            if (((_b = (_a = this.templates['value']) === null || _a === void 0 ? void 0 : _a.templateOrder) !== null && _b !== void 0 ? _b : 999) > this.templates['default'].templateOrder) {
                return html `
            ...
            if (this.resource) {
                try {
                    ...
                    if (!response) {
                        ...
                        if ((_a = this.response) === null || _a === void 0 ? void 0 : _a['@odata.deltaLink']) {
                        ...
                        if ((_b = this.scopes) === null || _b === void 0 ? void 0 : _b.length) {
                        ...
                        if (this.type === 'json') {
                            ...
                            if (isCollectionResponse(response) && response['@odata.nextLink']) {
                                ...
                                while ((pageCount < this.maxPages || this.maxPages <= 0 || (isDeltaLink && this.pollingRate)) &&
                                    (page === null || page === void 0 ? void 0 : page['@odata.nextLink'])) {
                                    pageCount++;
                                    const nextResource = page['@odata.nextLink'].split(this.version)[1];
                                    page = (yield graph.api(nextResource).version(this.version).get());
                                    if ((_c = page === null || page === void 0 ? void 0 : page.value) === null || _c === void 0 ? void 0 : _c.length) {
