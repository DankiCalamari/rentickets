...
import { MgtTemplatedTaskComponent, Providers, ProviderState, TeamsHelper, mgtHtml, customElementHelper } from '@microsoft/mgt-element';
...
export const registerMgtPersonCardComponent = () => {
    ...
    if (!customElements.get(buildComponentName('person')))
 ...
 *
 */
export class MgtPersonCard extends MgtTemplatedTaskComponent {
    /**
    ...
    constructor() {
     ...
     `;
        ...
        this.videoCallUser = () => {
            const user = this.personDetails;
            if ((user === null || user === void 0 ? void 0 : user.userPrincipalName) || (user === null || user === void 0 ? void 0 : user.mail)) {
                const users = user.userPrincipalName || user.mail;
    ...
    renderContactIcons(person) {
      ...
      `;
        ...
        // Chat
        let chat;
        if ((userPerson === null || userPerson === void 0 ? void 0 : userPerson.userPrincipalName) || (userPerson === null || userPerson === void 0 ? void 0 : userPerson.mail)) {
    ...
    loadState() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.personDetails) {
                const user = this.personDetails;
                const userId = user.userPrincipalName || user.id;
                ...
                if (userId && !getEmailFromGraphEntity(user)) {
                    const person = yield getUserWithPhoto(graph, userId);
                    this.personDetails = person;
                    this.personImage = this.getImage();
                }
            }
                ...
                if (people === null || people === void 0 ? void 0 : people.length) {
                    ...
                    yield getPersonImage(graph, this.personDetails, MgtPersonCardConfig.useContactApis).then(image => {
                        if (image) {
            ...
            const personId = ((_b = this.personDetails) === null || _b === void 0 ? void 0 : _b.id) || ((_c = this.personDetails) === null || _c === void 0 ? void 0 : _c.userPrincipalName);
            // populate state
            if (personId) {
                this._cardState = yield getPersonCardGraphData(graph, this.personDetails, this._me === personId);
            }
            this.loadSections();
    ...
    loadSections() {
        ...
        if (MgtPersonCardConfig.sections.organization && ((person === null || person === void 0 ? void 0 : person.manager) || (directReports === null || directReports === void 0 ? void 0 : directReports.length))) {
            this.sections.push(new MgtOrganization(this._cardState, this._me));
        }
        if (MgtPersonCardConfig.sections.mailMessages && (messages === null || messages === void 0 ? void 0 : messages.length)) {
...
], MgtPersonCard.prototype, "personQuery", null);
__decorate([
    property({
...
__decorate([
    state(),
    __metadata("design:type", Object)
], MgtPersonCard.prototype, "isSendingMessage", void 0);
__decorate([
    state(),
    __metadata("design:type", Object)
...
__decorate([
    state(),
    __metadata("design:type", Object)
], MgtPersonCard.prototype, "_currentSection", void 0);
