 ...
 */
export const getPhotoForResource = (graph, resource, scopes) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 * @memberof Graph
 */
export const getContactPhoto = (graph, contactId) => __awaiter(void 0, void 0, void 0, function* () {
    let cache;
    let photoDetails;
    ...
    photoDetails = yield getPhotoForResource(graph, `me/contacts/${contactId}`, validContactPhotoScopes);
    if (getIsPhotosCacheEnabled() && photoDetails) {
        yield cache.putValue(contactId, photoDetails);
    }
 ...
 * @memberof Graph
 */
export const getUserPhoto = (graph, userId) => __awaiter(void 0, void 0, void 0, function* () {
    let cache;
    let photoDetails;
    if (getIsPhotosCacheEnabled()) {
    ...
    photoDetails = photoDetails || (yield getPhotoForResource(graph, `users/${userId}`, anyUserValidPhotoScopes));
    if (getIsPhotosCacheEnabled() && photoDetails) {
        yield cache.putValue(userId, photoDetails);
    }
    return photoDetails ? photoDetails.photo : null;
});
/**
 ...
 * @memberof Graph
 */
export const myPhoto = (graph) => __awaiter(void 0, void 0, void 0, function* () {
    let cache;
    let photoDetails;
    if (getIsPhotosCacheEnabled()) {
        cache = CacheService.getCache(schemas.photos, schemas.photos.stores.users);
    ...
    photoDetails = photoDetails || (yield getPhotoForResource(graph, 'me', currentUserValidPhotoScopes));
    if (getIsPhotosCacheEnabled()) {
        yield cache.putValue('me', photoDetails || {});
    }
    return photoDetails ? photoDetails.photo : null;
});
/**
 ...
 * @export
 */
export const getPersonImage = (graph, person, useContactsApis = true) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if ('personType' in person && person.personType.subclass !== 'OrganizationUser') {
        if (person.personType.subclass === 'PersonalContact' && useContactsApis) {
            ...
            const contact = yield findContactsByEmail(graph, contactMail);
            if ((contact === null || contact === void 0 ? void 0 : contact.length) && contact[0].id) {
 ...
 * @returns
 */
export const getGroupImage = (graph, group) => __awaiter(void 0, void 0, void 0, function* () {
    let photoDetails;
    let cache;
    ...
    // if there is a photo in the cache, we got here because it was stale
    photoDetails = photoDetails || (yield getPhotoForResource(graph, `groups/${groupId}`, validGroupPhotoScopes));
    if (getIsPhotosCacheEnabled() && photoDetails) {
        yield cache.putValue(groupId, photoDetails);
    }
    return photoDetails ? photoDetails.photo : null;
});
/**
 ...
 * @memberof Graph
 */
export const getPhotoFromCache = (userId, storeName) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof Graph
 */
export const storePhotoInCache = (userId, storeName, value) => __awaiter(void 0, void 0, void 0, function* () {
    const cache = CacheService.getCache(schemas.photos, storeName);
    yield cache.putValue(userId, value);
});
