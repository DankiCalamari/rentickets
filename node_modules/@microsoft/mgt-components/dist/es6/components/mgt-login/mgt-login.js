...
export class MgtLogin extends MgtTemplatedTaskComponent {
    ...
    constructor() {
      ...
      <div class="login-root">
        ...
        this.onUserKeyDown = (e) => {
            ...
            const lastFocusableEl = el.querySelector('#signin-different-account-button') || focusableEls[focusableEls.length - 1];
            ...
            if (e.key === 'Escape') {
                ...
                loginButton === null || loginButton === void 0 ? void 0 : loginButton.focus();
            }
        ...
        this.handleAccountListKeyDown = (event) => {
            const list = this.renderRoot.querySelector('ul.account-list');
            let item;
            const listItems = list === null || list === void 0 ? void 0 : list.children;
            ...
            if (this._arrowKeyLocation > -1) {
                item = listItems[this._arrowKeyLocation];
    ...
    login() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (provider === null || provider === void 0 ? void 0 : provider.login) {
    ...
    renderButton() {
        ...
        const expandedState = showSignedInState ? this._isFlyoutOpen : undefined;
        return html `
      <fluent-button
        id="login-button"
    ...
    parsePersonDisplayConfiguration() {
        const displayConfig = { view: 'twolines', avatarSize: 'small' };
    ...
    renderAccounts() {
        if (Providers.globalProvider.state === ProviderState.SignedIn &&
            ...
            if ((accounts === null || accounts === void 0 ? void 0 : accounts.length) > 1) {
                return html `
          <div id="accounts">
            <ul
              tabindex="0"
...
__decorate([
    state(),
    __metadata("design:type", Object)
], MgtLogin.prototype, "_arrowKeyLocation", void 0);
