...
import { MgtTemplatedTaskComponent, ProviderState, Providers, mgtHtml } from '@microsoft/mgt-element';
...
import { PlannerTaskSource } from './task-sources';
...
export class MgtPlanner extends MgtTemplatedTaskComponent {
    ...
    constructor() {
      ...
      <div class="tasks">
        ...
        ${repeat(this.filteredTasks, task => task.id, task => this.renderTask(task))}
      </div>
    `;
        };
        this.onResize = () => {
      ...
      <div
        ...
        <div class="task-details-container">
          <div class="top">
            <div class="check-and-title">
              <fluent-checkbox
                @click=${(e) => this.handleTaskCheckClick(e, task)}
...
], MgtPlanner.prototype, "readOnly", void 0);
__decorate([
    property({ attribute: 'target-id', type: String }),
    __metadata("design:type", String)
], MgtPlanner.prototype, "targetId", void 0);
__decorate([
    property({ attribute: 'target-bucket-id', type: String }),
    __metadata("design:type", String)
], MgtPlanner.prototype, "targetBucketId", void 0);
__decorate([
    property({ attribute: 'initial-id', type: String }),
    __metadata("design:type", String)
], MgtPlanner.prototype, "initialId", void 0);
__decorate([
    property({ attribute: 'initial-bucket-id', type: String }),
    __metadata("design:type", String)
], MgtPlanner.prototype, "initialBucketId", void 0);
__decorate([
    property({ attribute: 'hide-header', type: Boolean }),
    __metadata("design:type", Boolean)
], MgtPlanner.prototype, "hideHeader", void 0);
__decorate([
    property({ attribute: 'hide-options', type: Boolean }),
    __metadata("design:type", Boolean)
], MgtPlanner.prototype, "hideOptions", void 0);
__decorate([
    property({ attribute: 'group-id', type: String }),
    __metadata("design:type", String)
], MgtPlanner.prototype, "groupId", void 0);
__decorate([
    state(),
    __metadata("design:type", Boolean)
], MgtPlanner.prototype, "_isNewTaskVisible", void 0);
__decorate([
    state(),
    __metadata("design:type", Boolean)
], MgtPlanner.prototype, "_newTaskBeingAdded", void 0);
__decorate([
    state(),
    __metadata("design:type", String)
], MgtPlanner.prototype, "_newTaskName", void 0);
__decorate([
    state(),
    __metadata("design:type", Date)
], MgtPlanner.prototype, "_newTaskDueDate", void 0);
__decorate([
    state(),
    __metadata("design:type", String)
], MgtPlanner.prototype, "_newTaskGroupId", void 0);
__decorate([
    state(),
    __metadata("design:type", String)
], MgtPlanner.prototype, "_newTaskFolderId", void 0);
__decorate([
    state(),
    __metadata("design:type", String)
], MgtPlanner.prototype, "_newTaskContainerId", void 0);
__decorate([
    state(),
    __metadata("design:type", Array)
], MgtPlanner.prototype, "_groups", void 0);
__decorate([
    state(),
    __metadata("design:type", Array)
], MgtPlanner.prototype, "_folders", void 0);
__decorate([
    state(),
    __metadata("design:type", Array)
], MgtPlanner.prototype, "_tasks", void 0);
__decorate([
    state(),
    __metadata("design:type", Array)
], MgtPlanner.prototype, "_hiddenTasks", void 0);
__decorate([
    state(),
    __metadata("design:type", Boolean)
], MgtPlanner.prototype, "_inTaskLoad", void 0);
__decorate([
    state(),
    __metadata("design:type", Boolean)
], MgtPlanner.prototype, "_hasDoneInitialLoad", void 0);
__decorate([
    state(),
    __metadata("design:type", String)
], MgtPlanner.prototype, "_currentGroup", void 0);
__decorate([
    state(),
    __metadata("design:type", String)
], MgtPlanner.prototype, "_currentFolder", void 0);
__decorate([
    state(),
    __metadata("design:type", Object)
], MgtPlanner.prototype, "_isDarkMode", void 0);
__decorate([
    state(),
    __metadata("design:type", Object)
], MgtPlanner.prototype, "_me", void 0);
//# sourceMappingURL=mgt-planner.js.map